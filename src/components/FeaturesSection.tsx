...
const DATA = [
  {
    ...
    description:
      "Create and send invoices in seconds. Get paid faster, every time.",
    icon: CircleHelp,
    image:
  ...
  {
    title: "No Awkward Chasing",
    description:
      "Automated reminders handle follow-ups. No more awkward emails.",
    icon: Volume2,
    image:
  ...
  },
  {
    ...
    description:
      "See who’s paid and who hasn’t at a glance. Stay on top, stress-free.",
    icon: Lightbulb,
    image:
